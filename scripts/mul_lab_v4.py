...
if __name__ == '__main__':
    ...
    for filename in mul_fileName:
        ...
        phone_start,syllable_start,word_start,sentence_start,utterance_start  = Get_start_stamp(text)
        phones_syllable,phones_word,phones_sentence,phones_utterance = Get_phone_num(text)
        ...
        phone_list,syllable_list,word_list,sentence_list = Get_word_list(
            text,syllable_start,word_start,sentence_start,
            phones_syllable,phones_word,phones_sentence)
        ...
        labelforall = LABELFORALL.Get_label(text,\
                phone_start,syllable_start,word_start,utterance_start, \
                phones_syllable,phones_word,phones_sentence,phones_utterance, \
                syllables_word,syllables_sentence,syllables_utterance, \
                words_sentence,words_utterance, \
        ...
        phone = PHONE.Get_label(text)
        curphone = PHONE.Get_phone()
        Labels = Labelforcategorical()
        labelforall = Labels.Get_label(text,\
                phone_start,syllable_start,word_start,utterance_start, \
                phones_syllable,phones_word,phones_sentence,phones_utterance, \
                syllables_word,syllables_sentence,syllables_utterance, \
                words_sentence,words_utterance, \
        ...
        syllable = SYLLABLE.Get_label(text,phone_start,syllable_start,phones_syllable,stress_count)
        word = WORD.Get_label(text,word_start,syllables_word)
        sentence = sentence.Get_label(text,sentence_start,syllables_sentence,words_sentence)
        utterance = utterance.Get_label(text,utterance_start,syllables_sentence,words_sentence,sentences_utterance)
        pos = POS.Get_label(text,word_start,GPOS_list)
        tone = TONE.Get_label(text,syllable_start,word_start,sentence_start,stress_count,syllables_sentence,words_sentence,stress_tag)
        #stress = STRESS.Get_label(text,stress_tag)
        position = POSITION.Get_label(text,phone_start,syllable_start,word_start,sentence_start, \
            phones_syllable,syllables_word,syllables_sentence,words_sentence,sentences_utterance)
        #tone = TONE.Get_label(text,syllable_start,word_start,sentence_start,stress_count,syllable_num_in_sentence,word_num_in_sentence)

        curphone = PHONE.Get_phone()
        #print(len(phone),len(phone3))

        label = gen_label(Start,End,phone,syllable,word,sentence,utterance,pos,tone,position)
        write_label_file(filename,hts_label_dir_path,label,curphone)
        '''
